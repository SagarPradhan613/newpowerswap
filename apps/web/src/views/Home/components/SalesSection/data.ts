...
export const earnSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  images: {
    ...
    attributes: [
      ...
      { src: 'folder', alt: t('Folder with POWER token') },
    ],
  },
})

export const cakeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  headingText: t('POWER makes our world go round.'),
  bodyText: t(
    'POWER token is at the heart of the PowerSwap ecosystem. Buy it, win it, farm it, spend it, stake it... heck, you can even vote with it!',
  ),
  reverse: false,
  primaryButton: {
