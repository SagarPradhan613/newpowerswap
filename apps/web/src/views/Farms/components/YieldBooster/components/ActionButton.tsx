...
const BoosterTooltip = () => {
  ...
  return (
    <>
      {t(
        `Boost multiplier is calculated based on the staking conditions from both Farms and fixed-term POWER pools and will be automatically updated upon user actions.`,
      )}
      <LinkExternal
