...
export const TEXT = {
  v2: {
    ...
    steps: [
      {
        title: <Trans>Unstaking LP Tokens and POWER</Trans>,
        subTitle: <Trans>All the earned POWER will be harvested to your wallet upon unstake.</Trans>,
  ...
  v3: {
    title: <Trans>POWERSWAP v3 Migration</Trans>,
    steps: [
      {
      ...
      },
      {
        ...
        subTitle: <Trans>Start earning POWER by staking your liquidity positions to V3 Farms!</Trans>,
