...
export const FarmMultiplierInfo: React.FC<React.PropsWithChildren<FarmMultiplierInfoProps>> = ({
  ...
  return (
    <>
      ...
      <Text my="24px">
        {t(
          "The Farm Multiplier represents the proportion of POWER rewards each farm receives as a proportion of its farm group."
        )}
      </Text>
      <Text my="24px">
        {t("For example, if a 1x farm received 1 POWER per block, a 40x farm would receive 40 POWER per block.")}
      </Text>
      <Text>
